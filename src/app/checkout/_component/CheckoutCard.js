...
export default function CheckoutCard() {
    ...
    return (
        <div className="mx-auto p-6 bg-white rounded-2xl shadow-lg mt-10">
            <h2 className="text-gray-700 font-medium mb-2">Apply Coupon</h2>
            <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden mb-4">
                ...
                />
                <button className="p-2 bg-teal-500  text-white" onClick={handleSubmit}>
                    ➜
                </button>
            </div>
